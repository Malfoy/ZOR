...
fn main() {
    ...
    let mut partition_counts = vec![1, 2, 4, 8, 16, 32, 64];
    ...
    println!(
        ...
        key_count, num_hashes, available_threads
    );
    ...
    for partition_count in partition_counts {
        ...
        println!(
            "partitions={:>3} target_size={:>9} build={:>6.3} s main_abandon={:>7.4}% bits/key={:>7.3} overhead={:>6.2}%",
            partition_count,
            target_partition_size,
            build_time,
            main_abandoned_pct,
